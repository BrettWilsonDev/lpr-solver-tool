...
PrimalTwoPhaseBase::PrimalTwoPhaseBase()
{
    // Init();
}
...
void PrimalTwoPhaseBase::StandardForm()
{
 ...
 *  * @throws None
 */
std::vector<std::vector<float>> PrimalTwoPhaseBase::BuildTableauMathFormExtended()
{
    return tableauMathForm;
}
 ...
 * @throws None
 */
void PrimalTwoPhaseBase::PerformPivotOperations(std::vector<std::vector<float>> tab)
{
...
void PrimalTwoPhaseBase::PerformPivotOperationsExtended(std::vector<std::vector<float>> tab)
{
}

void PrimalTwoPhaseBase::Solve()
{
    SolveExtended();
...
void PrimalTwoPhaseBase::SolveExtended()
{
}

void PrimalTwoPhaseBase::PrepSolutionDisplay()
{
