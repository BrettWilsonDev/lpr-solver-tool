...
if(EXISTS "C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitinfo.txt" AND
  ...
  message(STATUS
    ...
    "'C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'"
  )
  return()
endif()

execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-src"
  RESULT_VARIABLE error_code
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-src'")
endif()
...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe"
          checkout "head" --
  WORKING_DIRECTORY "C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-src"
  RESULT_VARIABLE error_code
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/brend/Desktop/web/lpr-solver-tool/build-emc/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'")
endif()
